...
internal sealed class KoenigseggJeskoDriverController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                lastFailure = reason;
                context?.Logger.Warn($"KoenigseggJesko driver vehicle={vehicleRoot.GetInstanceID()} " +
    ...
    private void CreateDriver()
    {
        ...
        if (ambientTraffic)
        {
            ...
            sourceNpc.name = "KoenigseggJesko_NpcAppearanceSource";
        ...
        driverRoot = new GameObject(ambientTraffic ? "KoenigseggJesko_SeatedNpcDriver" : "KoenigseggJesko_SeatedPlayer");
        ...
        if (ambientTraffic && KoenigseggJeskoDiagnostics.DebugEnabled &&
            KoenigseggJeskoDiagnostics.NpcDriverDebugEnabled)
            context?.Logger.Info($"KoenigseggJesko NPC driver vehicle={vehicleRoot?.GetInstanceID()} " +
    ...
    private void AlignWithSeat()
    {
        ...
        driverRoot.transform.rotation =
            vehicleRoot.rotation * Quaternion.Euler(-2f, 0f, 0f);
    ...
    {
        if (ambientTraffic && !KoenigseggJeskoDiagnostics.NpcDriverDebugEnabled)
            return;
        KoenigseggJeskoDiagnostics.Info(
            context,
            $"KoenigseggJesko driver vehicle={vehicleRoot?.GetInstanceID()} ambient={ambientTraffic}: {message}");
    }
