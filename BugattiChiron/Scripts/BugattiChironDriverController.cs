...
internal sealed class BugattiChironDriverController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                lastFailure = reason;
                context?.Logger.Warn($"BugattiChiron driver vehicle={vehicleRoot.GetInstanceID()} " +
    ...
    private void CreateDriver()
    {
        ...
        if (ambientTraffic)
        {
            ...
            sourceNpc.name = "BugattiChiron_NpcAppearanceSource";
        ...
        driverRoot = new GameObject(ambientTraffic ? "BugattiChiron_SeatedNpcDriver" : "BugattiChiron_SeatedPlayer");
        ...
        AlignHandsWithWheel();
        RaiseFeetAndKnees();
        if (ambientTraffic && BugattiChironDiagnostics.DebugEnabled &&
            BugattiChironDiagnostics.NpcDriverDebugEnabled)
            context?.Logger.Info($"BugattiChiron NPC driver vehicle={vehicleRoot?.GetInstanceID()} " +
