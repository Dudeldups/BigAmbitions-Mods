...
/// <summary>
/// Supplies the native warehouse transition with the fitted Dodge body's
...
internal sealed class DodgeChallenger2018WarehouseBoundsController : MonoBehaviour
{
    // The physical Dodge body spans 4.41m after its bumper-contact boxes.
    ...
    private static readonly Vector3 BoundsSize = new Vector3(2.01f, 1.46f, 7.62f);
    ...
    internal void Initialize()
    {
        ...
        placementMesh.name = "DodgeChallenger2018_WarehousePlacementBounds";
