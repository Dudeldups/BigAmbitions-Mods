...
/// <summary>
/// Supplies the native warehouse transition with the fitted Amarok body's
...
internal sealed class VolkswagenAmarokWarehouseBoundsController : MonoBehaviour
{
    // The physical Amarok body spans 4.41m after its bumper-contact boxes.
    ...
    internal void Initialize()
    {
        ...
        placementMesh.name = "VolkswagenAmarok_WarehousePlacementBounds";
