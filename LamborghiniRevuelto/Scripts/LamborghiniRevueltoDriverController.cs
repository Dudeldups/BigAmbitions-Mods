...
internal sealed class LamborghiniRevueltoDriverController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                lastFailure = reason;
                context?.Logger.Warn($"LamborghiniRevuelto driver vehicle={vehicleRoot.GetInstanceID()} " +
    ...
    private void CreateDriver()
    {
        ...
        if (ambientTraffic)
        {
            ...
            sourceNpc.name = "LamborghiniRevuelto_NpcAppearanceSource";
        ...
        driverRoot = new GameObject(ambientTraffic ? "LamborghiniRevuelto_SeatedNpcDriver" : "LamborghiniRevuelto_SeatedPlayer");
        ...
        AlignHandsWithWheel();
        RaiseFeetAndKnees();
        if (ambientTraffic && LamborghiniRevueltoDiagnostics.DebugEnabled &&
            LamborghiniRevueltoDiagnostics.NpcDriverDebugEnabled)
            context?.Logger.Info($"LamborghiniRevuelto NPC driver vehicle={vehicleRoot?.GetInstanceID()} " +
