...
/// reached before the vehicle-layer trigger can receive the Camaro collider.
/// </summary>
[AddComponentMenu("")]
[DisallowMultipleComponent]
internal sealed class ChevroletCamaro1967WarehouseEntryController : MonoBehaviour
{
    ...
    private void EnsureApproachTrigger()
    {
        ...
        var triggerObject = new GameObject("ChevroletCamaro1967_WarehouseApproachTrigger")
        {
    ...
    internal void SuppressEntrance(DriveInEntrance entrance, string reason)
    {
        ...
        ChevroletCamaro1967Diagnostics.WarehouseExitInfo(
            context,
            $"ChevroletCamaro1967 warehouse-entry: suppressing physical-door fallback for " +
    ...
    internal void ClearSuppressedEntrance(DriveInEntrance? entrance, string reason)
    {
        ...
        ChevroletCamaro1967Diagnostics.WarehouseExitInfo(
            context,
            $"ChevroletCamaro1967 warehouse-entry: restoring physical-door fallback for " +
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        ChevroletCamaro1967Diagnostics.WarehouseExitInfo(
            context,
            $"ChevroletCamaro1967 warehouse-entry: physical door collision invokes native entry; " +
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (entrance == suppressedEntrance)
        {
            if (Time.unscaledTime >= nextSuppressionLogTime)
            {
                ...
                ChevroletCamaro1967Diagnostics.WarehouseExitInfo(
                    context,
                    $"ChevroletCamaro1967 warehouse-entry: approach trigger suppressed during warehouse " +
        ...
        ChevroletCamaro1967Diagnostics.WarehouseExitInfo(
            context,
            $"ChevroletCamaro1967 warehouse-entry: approach trigger invokes native entry; " +
            $"instance={vehicle.GetInstanceID()}, entrance='{entrance.name}', " +
        ...
        Vector3 relativeVelocity)
    {
        ...
        ChevroletCamaro1967Diagnostics.WarehouseExitInfo(
            context,
            $"ChevroletCamaro1967 warehouse-entry: physical-door fallback suppressed during " +
